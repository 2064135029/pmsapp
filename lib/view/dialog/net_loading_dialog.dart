...
class NetLoadingDialog extends StatefulWidget{
  ...
  String loadingText;
  bool outsideDismiss; // 是否点击关闭
  bool isLoading; // 是否展示Loading
  Function dismissDialog;

  NetLoadingDialog({Key key, this.loadingText = "loading...", this.outsideDismiss = true, this.isLoading = true,this.dismissDialog}): super(key: key);
